...
#  ../LibNEST_TB${TB}/testNEST 100000 beta 2.8 2.8 -1 -1,-1,-1 >../Data/${sName}_TB${TB}_newlibnest.dat
  ../LibNEST_TB${TB}/testNEST 100000 beta 42 42 -1 -1,-1,-1 >../Data/${sName}_TB${TB}_newlibnest.dat
