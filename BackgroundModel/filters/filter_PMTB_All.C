...
void filter_PMTB_All_planB(){
    
    // Create chain with the original RQ files, containing all the events
    TChain *ch1 = new TChain("events");
    
    ch1->Add("/cms26r0/sjh/lux_bkg_model/planB_bkg_model/root_output/PMTB_Co60_summary.root");
    ch1->Add("/cms26r0/sjh/lux_bkg_model/planB_bkg_model/root_output/PMTB_K40_summary.root");
    ch1->Add("/cms26r0/sjh/lux_bkg_model/planB_bkg_model/root_output/PMTB_Ra226_summary.root");
    ch1->Add("/cms26r0/sjh/lux_bkg_model/planB_bkg_model/root_output/PMTB_Th232L_summary.root");
    
    //    TChain *ch1  = (TChain*)gROOT->FindObject("events");
    
    // Open the root file where golden events will be written
    TFile *hfile = new TFile("/cms26r0/sjh/lux_bkg_model/planB_bkg_model/planB_BkgModelInputs/goldenPMTB_All.root","RECREATE");
