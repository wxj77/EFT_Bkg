...
void filter_Ex_Th232_planB(){
    
    // Create chain with the original RQ files, containing all the events
    TChain *ch1 = new TChain("events");
    
    ///-------------------
    ch1->Add("/cms26r0/sjh/lux_bkg_model/planB_bkg_model/root_output/CRYOSTAT_Th232E_summary.root");
    ch1->Add("/cms26r0/sjh/lux_bkg_model/planB_bkg_model/root_output/FCSHIELD_Th232E_summary.root");
    ch1->Add("/cms26r0/sjh/lux_bkg_model/planB_bkg_model/root_output/FIELDGRID_Th232E_summary.root");
    ch1->Add("/cms26r0/sjh/lux_bkg_model/planB_bkg_model/root_output/FIELDRING_Th232E_summary.root");
    ch1->Add("/cms26r0/sjh/lux_bkg_model/planB_bkg_model/root_output/HDPE_Th232E_summary.root");
    ch1->Add("/cms26r0/sjh/lux_bkg_model/planB_bkg_model/root_output/MYLAR_Th232E_summary.root");
    ch1->Add("/cms26r0/sjh/lux_bkg_model/planB_bkg_model/root_output/PMTMOUNT_Th232E_summary.root");
    ch1->Add("/cms26r0/sjh/lux_bkg_model/planB_bkg_model/root_output/PTFE_Th232E_summary.root");
    ch1->Add("/cms26r0/sjh/lux_bkg_model/planB_bkg_model/root_output/REFLECTOR_Th232E_summary.root");
    ch1->Add("/cms26r0/sjh/lux_bkg_model/planB_bkg_model/root_output/THERMALSHIELD_Th232E_summary.root");
    ch1->Add("/cms26r0/sjh/lux_bkg_model/planB_bkg_model/root_output/TOPSHIELD_Th232E_summary.root");
    
    //    TChain *ch1  = (TChain*)gROOT->FindObject("events");
    
    // Open the root file where golden events will be written
    TFile *hfile = new TFile("/cms26r0/sjh/lux_bkg_model/planB_bkg_model/planB_BkgModelInputs/goldenEx_Th232.root","RECREATE");
