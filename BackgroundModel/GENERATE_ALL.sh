...
# if not load ROOT gcc # only valid for NESRC
#module unload ROOT
...
for TB in 1 2 3 4; do
#	root -b -l -q "generate_Bkg_S1Log10S2_TH2F.C+(10000, ${TB})"
	root -b -l -q "generate_Bkg_S1Log10S2_TH2F_Ar37.C+(10000, ${TB})"
done;

#Accidental, I don't know how to interpolate this.
#root -b -q -l "makeAccidentalsTH2.C()"
cd extendAccidentals
root -b -l -q "extendAccidentals.C()"
cd ..
